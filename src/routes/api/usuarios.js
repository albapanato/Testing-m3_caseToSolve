...
const { getAll, newUser, updateUser, deleteUser, getByEmail } = require('../../models/model.usuarios')
...
router.post('/',
    ...
    body(
        'password',
        'Es requerido una longitud mínima de 6 caracteres'
...
router.delete('/delete/:usuarioId', verifyIsAdmin, (req, res) => { // Usando promesas
